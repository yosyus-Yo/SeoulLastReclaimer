...
[웹 게임플레이 확장 진단·모션 제작 계획](design/docs/29_Web_Gameplay_Expansion_Plan.md): 현재 구현과 미구현 기능, 점프·장애물 올라타기·실내·외벽 등반·낙하 피해, 모션/이펙트 목록, 단계별 제작 및 검증 계획을 정리한 검토 초안입니다. 신규 기능을 구현 완료했다는 의미는 아닙니다.
